...
import com.barassolutions.Token;
...
/**
 * The AST node for a local variable/method/etc. declaration. Local names are declared
...
public class DeclarationPart extends Statement {
  ...
  /**
   * Whether these variables are constants. Note that this concept is totally new to NewOz, since Oz only supports constant values.
   * In NewOz, one can declare variables, which are a wrapper for Cells.
   */
