...
public class ReturnStatement extends Statement {
  ...
  /**
   * Analyze the expression and check types.
   ...
   * procedures, generate a simple (void) return. In the
   * case of a return expression, generate code for the appropriate
   * return instruction.
   *
   * @param output
   *                the code emitter (basically an abstraction
   *                for producing the Oz file).
   */
  @Override
