...
- rigorous comparison vs Scala and Ozma(for concurrency) -> these are our landmark. What are deltas w/them ? Acceptable delta ?
- user feedback - what is nice and not nice
