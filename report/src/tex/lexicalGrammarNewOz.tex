\begin{lstlisting}[label={lst:newOzLexical},frame=single,basicstyle=\footnotesize,escapeinside={(*}{*)}]
...
// Multi-line comments - ignored TODO these comments should be nestable -> wrong definition here
"/*" {CHAR - "*/"} "*/"
